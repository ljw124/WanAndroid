...
import com.dcdz.wanandroid.event.ColorEvent
import com.dcdz.wanandroid.event.LoginEvent
import com.dcdz.wanandroid.event.RefreshHomeEvent
import com.dcdz.wanandroid.event.showToast
import com.dcdz.wanandroid.mvp.contract.MainContract
import com.dcdz.wanandroid.mvp.presenter.MainPresenter
import com.dcdz.wanandroid.ui.fragment.HomeFragment
import com.dcdz.wanandroid.utils.DialogUtil
        ...
        when (index) {
            ...
            -> {
                ...
                if (mKnowledgeTreeFragment == null) {
                    mKnowledgeTreeFragment = HomeFragment.getInstance()
            ...
            -> {
                ...
                if (mNavigationFragment == null) {
                    mNavigationFragment = HomeFragment.getInstance()
            ...
            -> {
                ...
                if (mProjectFragment == null) {
                    mProjectFragment = HomeFragment.getInstance()
            ...
            -> {
                ...
                if (mWeChatFragment == null) {
                    mWeChatFragment = HomeFragment.getInstance()
