package com.dcdz.wanandroid.event
...
import com.dcdz.wanandroid.widget.CustomToast
...
fun Activity.showSnackMsg(msg: String) {
    ...
    view.findViewById<TextView>(R.id.snackbar_text).setTextColor(ContextCompat.getColor(this, R.color.viewBackground))
    snackbar.show()
}
...
fun Fragment.showSnackMsg(msg: String) {
    ...
    val view = snackbar.view
    view.findViewById<TextView>(R.id.snackbar_text).setTextColor(ContextCompat.getColor(this.activity!!, R.color.viewBackground))
    snackbar.show()
}
